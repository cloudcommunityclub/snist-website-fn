            ...
            <div className='max-w-lg w-full font-mono'>
                <div className='border border-[#6272a4]/40 rounded-lg overflow-hidden'>
                    ...
                    <div className='bg-[#0d0e12] p-6 space-y-3'>
                        ...
                        <div className='text-[#ffb86c] text-4xl font-bold'>
                            404
                        </div>
                        <div className='text-[#f8f8f2] text-sm'>
                            <span className='text-[#ff5555]'>Error:</span> Route
                            not found in system.
                        </div>
                        <div className='text-[#6272a4] text-xs'>
                            The path you requested does not exist on this
                            server.
                        </div>
                        <div className='pt-4 border-t border-[#6272a4]/20'>
                            <div className='text-[#6272a4] text-xs mb-2'>
                                # Available routes
                            </div>
                            {[
                                ['/', 'home'],
                                ...
                                <div key={href} className='text-xs'>
                                    ...
                                    <Link
                                        href={href}
                                        className='text-[#8be9fd] hover:text-[#bd93f9] transition-colors'
                                    >
                                        {href}
                                    </Link>
                                    <span className='text-[#6272a4] ml-2'>
                                        # {label}
                                    </span>
                                </div>
                            ))}
                        ...
                        <div className='pt-2'>
                            ...
                            >
                                <span className='text-[#ff79c6]'>cd</span>{' '}
                                ~/home
                            </Link>
                        </div>
                    </div>
