...
const internshipsData: Internship[] = [
    {
        ...
        description:
            "A Nationwide AI Internship to Build the World's First Telugu Large Language Model (LLM). Get hands-on training in cutting-edge AI technologies while contributing to this groundbreaking project.",
        ...
        <div className='min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white'>
            ...
            <div className='relative h-[50vh] overflow-hidden'>
                ...
                <div className='relative z-20 container mx-auto px-6 h-full flex flex-col justify-center'>
                    ...
                    >
                        Kickstart your career with hands-on experience in the
                        tech industry. Explore our curated list of internships
            ...
            <div className='container mx-auto px-6 py-16'>
                <div className='text-center mb-12'>
                    ...
                    <p className='text-gray-400 max-w-2xl mx-auto'>
                        Our internship program offers a unique opportunity to
                        gain valuable experience and kickstart your career in
                        the tech industry.
                    </p>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    >
                        ...
                        <p className='text-gray-400'>
                            Work on actual projects that matter and contribute
                    ...
                    >
                        ...
                        <p className='text-gray-400'>
                            Learn from industry professionals who are passionate
                            about helping you grow.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className='text-gray-400'>
                            Enhance your technical and soft skills through
                    ...
                    >
                        ...
                        <p className='text-gray-400'>
                            Top performers may receive pre-placement offers and
                ...
                <div className='flex flex-col md:flex-row items-start gap-12'>
                    <div className='w-full md:w-1/2'>
                        ...
                        <p className='text-xl text-gray-200 mb-6 italic'>
                            A Nationwide AI Internship to Build the World's
                            First Telugu LLM
                        </p>

                        <p className='text-gray-300 mb-6'>
                            Summer of AI 2025 is an AI internship program
                            empowering students to contribute to the world's
                            first Telugu Large Language Model (LLM) and get
                            hands-on training in cutting-edge AI technologies.
                        </p>
                        ...
                        <div className='mb-8'>
                            ...
                            <ul className='space-y-3 text-gray-300'>
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        <strong>Organizers:</strong> Swecha
                                        Telangana, Viswam.ai, IIIT Hyderabad,
                                        Meta, Ozonetel, TASK, HySEA
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    <div className='bg-blue-500/20 p-1 rounded-full mr-3 mt-1'>
                                ...
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        <strong>Mode:</strong> Hybrid (Online +
                                        Offline Sessions)
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        <strong>Target:</strong> Training 1 Lakh
                                        AI Engineers across Telangana and Andhra
                                        Pradesh
                                    </span>
                                </li>
                            </ul>
                        ...
                        <div className='mb-8'>
                            ...
                            <ul className='space-y-3 text-gray-300'>
                                ...
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        Data Collection & Preprocessing for LLMs
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    <div className='bg-purple-500/20 p-1 rounded-full mr-3 mt-1'>
                                ...
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        Hands-on contribution to the Telugu LLM
                                        Project
                                    </span>
                                </li>
                            </ul>
                        ...
                        <div className='bg-gray-800/50 p-6 rounded-xl border border-gray-700'>
                            ...
                            <ul className='space-y-3 text-gray-300 mb-6'>
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        ...
                                        (co-issued by IIIT-H, Meta, Ozonetel,
                                        TASK & Swecha)
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        Mentorship from industry experts and AI
                                        researchers
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    ...
                                    <span>
                                        Opportunity to showcase your AI projects
                                    </span>
                                </li>
                                <li className='flex items-start'>
                                    <div className='bg-green-500/20 p-1 rounded-full mr-3 mt-1'>
                                    ...
                                    <span>
                                        Network with 1 Lakh+ AI enthusiasts and
                                        practitioners
                                    </span>
                                </li>
                            </ul>
                            ...
                            <div className='mt-6'>
                                <p className='text-center mt-4 text-gray-400'>
                                    Become a part of the AI revolution and help
                                    build India's first native-language LLM.
                                </p>
                                <Link
