        ...
        <div className='w-full h-[220vh] relative overflow-hidden'>
            ...
            <div className='w-full h-[110vh] flex absolute bottom-[12rem] flex-col gap-4 justify-center items-center'>
                ...
                <div className='w-[75%]'>
                    ...
                    {/* Discord Widget */}
                    <iframe src="https://e.widgetbot.io/channels/1316108296075218944/1316108302404550658" 
                    ...
                    <a href='https://discord.gg/kx9VH9pu' target='_blank' className='w-[75%] h-[72px] hover:scale-[101%] hover:animate-pulse transition-all opacity-70 hover:opacity-85 duration-300'>
                        <iframe
                        title='discord'
