...
const activities: Activity[] = [
    {
        ...
        description:
            'Master industry-standard tools and stay ahead in the evolving technology landscape.',
        icon: Rocket,
    },
    {
        title: 'Open Source Contributions',
        description:
            'Contribute to free and open source projects and make a meaningful impact in the tech community.',
        icon: BookOpen,
    },
    {
        title: 'Research Driven Activities',
        description:
            'Explore and advance in your field of interest through research papers and innovative projects.',
        icon: FlaskConical,
    },
    {
        title: 'Networking',
        description:
            'Connect with like-minded people, because your network is your net worth in the tech industry.',
        icon: Users,
    },
]
...
const ActivityItem = ({
    ...
    const opacity = useTransform(
        ...
        [0.3, 1]
    ) // Reduced initial opacity for contrast
    ...
    const glow = useTransform(
        progress,
        [rangeStart, rangeStart + 0.1],
        ['0px 0px 0px rgba(0,0,0,0)', '0px 0px 30px rgba(45,212,191,0.3)']
    ) // Cyan glow
    const border = useTransform(
        progress,
        [rangeStart, rangeStart + 0.1],
        ['rgba(255,255,255,0.05)', 'rgba(45,212,191,0.3)']
    ) // Cyan border
            ...
            <div className='flex-1 pl-20 md:pl-0'>
                ...
                >
                    ...
                    <div className='relative z-10'>
                        ...
                        <h3 className='text-2xl font-bold font-display mb-3 text-slate-100'>
                            {step.title}
                        </h3>
            ...
            <div className='w-full max-w-7xl mx-auto px-4 md:px-6 relative z-10'>
                ...
                >
                    ...
                    <p className='text-lg text-neutral-400 max-w-2xl mx-auto'>
                        Join us in our journey to explore, contribute, research,
                        and network in the world of technology.
                    </p>
                </motion.div>
