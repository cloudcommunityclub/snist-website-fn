        ...
        <div className='relative min-h-screen bg-black flex flex-col items-center justify-start overflow-hidden pt-16 sm:pt-24'>
            ...
            <div className='relative z-10 w-full px-4 py-8 sm:py-12 max-w-7xl mx-auto'>
                ...
                >
                    ...
                    >
                        We're launching Project Schools under C³, where we'll
                        collaborate on exciting tech projects, learn new skills,
                    ...
                    >
                        ...
                        >
                            ...
                            <p className='text-gray-300 text-center'>
                                ...
                                real-world projects with cutting-edge
                                technologies
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className='text-gray-300 text-center'>
                                Work alongside peers and mentors in a supportive
                        ...
                        >
                            ...
                            <p className='text-gray-300 text-center'>
                                Create impressive projects that showcase your
