...
export default function Roadmap() {
    return (
        <section
            className='relative w-full py-28 md:py-36 bg-black overflow-hidden'
            id='roadmap'
        >
            {/* Ambient glow */}
                ...
                <div className='mb-20 md:mb-28 text-center'>
                    ...
                    >
                        ...
                        <p className='mt-5 max-w-lg mx-auto text-gray-500 text-base md:text-lg font-light leading-relaxed'>
                            Four simple stages. No shortcuts, no forms, no
                            politics. Do real work in public, prove what you can
                            do, and earn your place.
                        </p>
                    </motion.div>
                </div>
