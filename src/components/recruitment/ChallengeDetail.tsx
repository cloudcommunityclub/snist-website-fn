...
const instructions = [
    {
        ...
        description:
            'Visit the GitHub issue and claim it by commenting. Pick only ONE problem across all categories.',
    },
    {
        step: '02',
        title: 'Fork & Clone',
        ...
        return (
            <div className='mt-8 p-5 bg-cyan-400/5 border border-cyan-500/20 rounded-xl text-center'>
                ...
                <p className='text-cyan-400 font-mono text-sm'>
                    PR submission recorded. Good luck!
                </p>
                <p className='text-gray-600 font-mono text-xs mt-1'>
                    We&apos;ll be in touch for the next round.
                </p>
            </div>
        )
    }
        ...
        >
            ...
            <div className='bg-white/[0.02] border border-white/[0.06] rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm'>
                ...
                <div className='flex items-center gap-2 px-5 py-3.5 bg-white/[0.03] border-b border-white/[0.06]'>
                    ...
                    <div className='w-2.5 h-2.5 rounded-full bg-white/10' />
                    <div className='w-2.5 h-2.5 rounded-full bg-white/10' />
                    <span className='ml-4 font-mono text-white/20 text-xs truncate'>
                ...
                <div className='p-5 sm:p-6 md:p-8'>
                    ...
                    <div className='mb-6 p-4 bg-white/[0.02] border border-white/[0.05] rounded-xl'>
                        <p className='font-mono text-white/30 text-xs uppercase tracking-widest mb-1'>
                            How it works
                        </p>
                        <p className='text-gray-500 text-sm font-light leading-relaxed'>
                            ...
                            from any category. Claim the GitHub issue, implement
                            your solution. — we track all submissions in our
                            backend.
                        </p>
                    </div>
