                    ...
                    >
                        ...
                        <div className='text-center mb-8'>
                            ...
                            <p className='text-gray-500 text-sm font-light'>
                                Complete verification to access classified
                                challenges
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            <div>
                                <label
                                    htmlFor='name'
                                    className='block text-white/30 text-xs uppercase tracking-widest mb-2 font-mono'
                                >
                                    Full Name
                                </label>
                                <input
                            ...
                            <div>
                                ...
                                <div className='flex items-center border-b border-white/[0.06]'>
                                    <span className='text-white/40 py-3 pr-2'>
                                        +91
                                    </span>
                                    <input
                                        type='tel'
