...
const connectSrc = [
    ...
    'https://*.spline.design',
    'https://c3-backend-cnhr.onrender.com',
    'http://localhost:5000',
]
                ...
                headers: [
                    {
                        ...
                        value: `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.ravenjs.com https://*.widgetbot.io https://*.discord.com https://va.vercel-scripts.com https://prod.spline.design https://*.spline.design; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.widgetbot.io https://*.discord.com; img-src 'self' data: https://*.discordapp.com https://*.discord.com https://prod.spline.design https://*.spline.design https://images.unsplash.com; font-src 'self' https://fonts.gstatic.com https://*.widgetbot.io https://*.discord.com; connect-src ${connectSrc.join(' ')}; frame-src 'self' https://*.widgetbot.io https://*.discord.com https://prod.spline.design https://*.spline.design;`,
                    },
                    {
